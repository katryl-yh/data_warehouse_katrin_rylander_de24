...
-- 3 ROLES 
CREATE ROLE IF NOT EXISTS ice_cream_reader COMMENT = 'Able to read ice_cream database';
CREATE ROLE IF NOT EXISTS ice_cream_writer 
COMMENT = 'Able to do CRUD operations on ice_cream database';
CREATE ROLE IF NOT EXISTS ice_cream_analyst 
...
GRANT ROLE ice_cream_writer TO USER krylander;
GRANT ROLE ice_cream_reader TO USER krylander;
