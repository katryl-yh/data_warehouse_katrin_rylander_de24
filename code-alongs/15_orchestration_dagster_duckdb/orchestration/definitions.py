...
# create a manifest json file; compiles the dbt project & allow Dagster to build an asset graph
dbt_project.prepare_if_dev()

# create dagster dbt asset; Yields Dagster events streamed from the dbt CLI
